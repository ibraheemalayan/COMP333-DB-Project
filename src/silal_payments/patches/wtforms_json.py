    ...
    for key, value in json.items():
        try:
            ...
            if skip_unknown_keys:
                ...
                raise InvalidData("Unknown field name '%s'." % key)
        ...
        try:
            ...
            if skip_unknown_keys:
                ...
                raise InvalidData("Key '%s' is not valid field class." % key)
...
def patch_data(self):
    ...
    def is_required(field):
        return InputRequired in [v.__class__ for v in field.validators]
