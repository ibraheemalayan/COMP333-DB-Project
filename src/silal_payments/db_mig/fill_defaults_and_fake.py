...
with alive_bar(
    ...
    bar()
    bar()
    products = insert_random_products(100, sellers)
    bar()
    bar()
    bar()
    ...
    bar()
    orders = insert_random_orders(100, customers, drivers)
    bar()
    bar()
    bar()
    order_items = insert_random_order_items(orders, products)
    bar()
    transactions = insert_random_transactions(100, customers, sellers, drivers, orders)
    bar()
    bar()
