...
with alive_bar(
    ...
    bar()
    bar()
    products = insert_random_products(randint(90, 150), sellers)
    bar()
    bar()
    bar()
    customers = insert_random_customers(70)
    bar()
    bar()
    drivers = insert_random_drivers(30)
    bar()
    orders = insert_random_orders(randint(90, 150), customers, drivers)
    bar()
    bar()
    bar()
    order_items = insert_random_order_items(orders, products)
    bar()
    transactions = insert_random_transactions(
        randint(90, 150), customers, sellers, drivers, orders
    )
    bar()
    bar()
